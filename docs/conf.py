...
project = u'ephys_anonymizer'
td = date.today()
copyright = (u'2020-{}, EPHYS-ANONYMIZER Developers. Last updated on '
             '{}'.format(td.year, td.isoformat()))

author = u'EPHYS-ANONYMIZER Developers'
...
version = ephys_anonymizer.__version__
...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ("GitHub", "https://github.com/alexrockhill/ephys-anonymizer", True),
    ]}
...
sphinx_gallery_conf = {
    'doc_module': 'ephys_anonymizer',
    'reference_url': {
        'ephys_anonymizer': None,
    },
